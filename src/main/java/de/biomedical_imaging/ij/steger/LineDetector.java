...
public class LineDetector {
    ...
    /**
     * @param ip                The image where the lines should be detected
     * @param sigma             A value which depends on the line width: sigma >=
     *                          width/(2*sqrt(3))
     * @param upperThresh       Upper hysteresis thresholds used in the linking algorithm
     *                          (Depends on the maximum contour brightness (greyvalue))
     * @param lowerThresh       Lower hysteresis thresholds used in the linking algorithm
     *                          (Depends on the minimum contour brightness (greyvalue)).
     * @param isDarkLine        True if the line darker than the background
     * @param doCorrectPosition Determines whether the line width and position correction
     *                          should be applied
     * @param doEstimateWidth   Determines whether the line width should be extracted
     * @param doExtendLine      Extends the detect lines to find more junction points
